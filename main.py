...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.initializateConfigWindow()

        self.uiNewWindow.fixedColorBackgroundCheckBox.clicked.connect(lambda: self.enableChangeBackgroundColor())
        self.uiNewWindow.fixedColorTrackNameCheckBox.clicked.connect(lambda: self.enableChageTrackNameColor2())
        self.uiNewWindow.fixedColorArtistsCheckBox.clicked.connect(lambda: self.enableChageNameArtistsColor2())
        self.uiNewWindow.fixedColorProgrsbarAddCheckBox.clicked.connect(lambda: self.enableChangeProgresbarAddColor2())
        self.uiNewWindow.fixedColorProgresbarSubCheckBox.clicked.connect(lambda: self.enableChangeProgresbarSubColor2())
        self.uiNewWindow.fixedColorProgresbarHandlerCheckBox.clicked.connect(lambda: self.enableChangeProgresbarHandlerColor2())
    ...
    def readConfig(self):
        with open(r"C:\Users\user\PycharmProjects\WallpapersFromSpotify\config.json") as configFile:
    ...
    def initializateConfigWindow(self):
        self.readConfig()

        self.uiNewWindow.fixedColorBackgroundCheckBox.setChecked(self.backgroungColorFixed)
    ...
    def enableChageTrackNameColor2(self):
    ...
    def enableChageNameArtistsColor2(self):
    ...
    def enableChangeProgresbarAddColor2(self):
    ...
    def enableChangeProgresbarSubColor2(self):
    ...
    def enableChangeProgresbarHandlerColor2(self):
